...
# change path
set NETLIST ../tmp_sim_data_croc/netlist_debug.v

# change path
set VCD     ../tmp_sim_data_croc/croc.vcd          
# post-synth
...
# io cells
set IO_DIR ${PDK_DIR}/sg13g2_io/lib
set IO_LIB sg13g2_io_typ_1p2V_3p3V_25C.lib
...
report_power -nosplit -sort_by total_power -hierarchy -significant_digits 6 > reports/power/croc_soc_power.rpt
