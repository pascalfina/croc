...
set NETLIST /scratch/sem26f37/croc_burst2/tmp_sim_data_croc/pt_package_khanh_20260721/bare/croc_bare.v

set TOP        croc_chip
set REPORT  [expr {[info exists env(REPORT_NAME)] ? $env(REPORT_NAME) : "khanh_bare_1p08.rpt"}]
...
set VCD /scratch/sem26f37/croc_burst2/tmp_sim_data_croc/pt_package_khanh_20260721/bare/croc_khanh_bare.vcd
...
set SPEF /scratch/sem26f37/croc_burst2/tmp_sim_data_croc/pt_package_khanh_20260721/bare/croc_bare.spef
...
set STDCELL_LIB sg13g2_stdcell_slow_1p08V_125C.lib
...
set SRAM_LIB_64x64   RM_IHPSG13_1P_64x64_c2_bm_bist_slow_1p08V_125C.lib
set SRAM_LIB_256x64  RM_IHPSG13_1P_256x64_c2_bm_bist_slow_1p08V_125C.lib
set SRAM_LIB_512x64  RM_IHPSG13_1P_512x64_c2_bm_bist_slow_1p08V_125C.lib
set SRAM_LIB_1024x64 RM_IHPSG13_1P_1024x64_c2_bm_bist_slow_1p08V_125C.lib
set SRAM_LIB_2048x64 RM_IHPSG13_1P_2048x64_c2_bm_bist_slow_1p08V_125C.lib
