...
if {[catch { vlog -incr -sv \
    ...
    "$ROOT/rtl/burst/test/obi_burst_check.sv" \
    "$ROOT/rtl/burst/test/burst_contention_check.sv" \
    "$ROOT/rtl/burst/test/burst_addr_monitor.sv" \
}]} {return 1}
